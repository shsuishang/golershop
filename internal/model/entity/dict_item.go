...
// DictItem is the golang structure for table dict_item.
type DictItem struct {
	DictItemId      string `json:"dict_item_id"      ` // 字典项编号
	...
	DictItemBuildin bool   `json:"dict_item_buildin" ` // 系统内置(BOOL):1-是; 0-否
}

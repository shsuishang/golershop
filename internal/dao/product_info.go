...
// internalProductInfoDao is internal type for wrapping internal DAO implements.
...
var (
	// ProductInfo is globally public accessible object for table pt_product_info operations.

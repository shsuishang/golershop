...
type (
	IMessageTemplate interface {
		Find(ctx context.Context, in *do.MessageTemplateListInput) (out []*entity.MessageTemplate, err error)
		List(ctx context.Context, in *do.MessageTemplateListInput) (out *do.MessageTemplateListOutput, err error)
		Add(ctx context.Context, in *do.MessageTemplate) (lastInsertId int64, err error)
		Edit(ctx context.Context, in *do.MessageTemplate) (affected int64, err error)
